...
from src.internvl.extraction.json_extraction import extract_json_from_text
...
def normalize_date(date_str: str) -> str:
    ...
    try:
        ...
        if ' ' in date_str and not any(x in date_str.lower() for x in ['jan', 'feb', 'mar', 'apr', 'may', 'jun', 'jul', 'aug', 'sep', 'oct', 'nov', 'dec']):
