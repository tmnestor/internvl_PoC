...
from src.internvl.utils.path import project_root

def main():
    """Test image path resolution for different image path formats."""
    print(f"Testing image path resolution (fail early)")
    print(f"=========================================")
    ...
    if alt_path.exists():
        ...
        print(f"Image not found in common locations. Please provide a valid path.")
